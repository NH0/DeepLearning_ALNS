...
def generate_cvrp_instance(size=50, capacity=40, number_of_depots=1):
    ...
    random_nodes_demands = np.random.uniform(1, 10, size) / capacity

    # Nodes have three attributes : coordinates, demand (which is negative for the depot) and a boolean to know if it is a depot
    nodes = [(i,
